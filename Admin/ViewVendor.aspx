<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="ViewVendor.aspx.cs" Inherits="Admin_ViewVendor" %>
    ...
    <div class="container centerdiv">
        ...
        <asp:Panel ID="PanelServiceDetails" Visible="false" runat="server">
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <asp:Label runat="server" Text="Distritbutor/Brand: "></asp:Label>
