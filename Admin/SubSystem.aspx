<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="SubSystem.aspx.cs" Inherits="Admin_SubSystem" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container centerdiv">
        <div class="form-group">
            <h4 class="text-center">Sub-System Information</h4>
        </div>
        <br />
        <div class="centerdiv">
            <asp:Panel ID="PanelAddInfo" Visible="false" runat="server">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtTitle" class="form-control" placeholder="Sub-System Title" runat="server">
                    </asp:TextBox>
                ...
                <div class="gridviewScrollable">
                    ...
                    <asp:GridView ID="GridView1" CssClass="table text-nowrap" EmptyDataText="No records to show" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" AllowPaging="True" GridLines="None" OnPageIndexChanging="GridView1_PageIndexChanging" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" PageSize="20">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Sub-System Title" SortExpression="Title">
                                <ItemTemplate>
